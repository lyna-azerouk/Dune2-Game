...
/* package tuto-quickcheck-0.1.0.0 */
#ifndef VERSION_tuto_quickcheck
#define VERSION_tuto_quickcheck "0.1.0.0"
#endif /* VERSION_tuto_quickcheck */
#ifndef MIN_VERSION_tuto_quickcheck
#define MIN_VERSION_tuto_quickcheck(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_tuto_quickcheck */
...
#define CURRENT_PACKAGE_KEY "tuto-quickcheck-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "tuto-quickcheck-0.1.0.0-inplace"
